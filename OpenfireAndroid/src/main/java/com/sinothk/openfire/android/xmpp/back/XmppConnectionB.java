...
//import com.sinothk.openfire.android.xmpp.FormatTools;
//import com.sinothk.openfire.android.xmpp.XMConnectionListener;
//
...
// * @ Describe
// */
//public class XmppConnectionB {
//
//    private volatile static XmppConnectionB singleton;
//
//    public static XmppConnectionB getInstance() {
//        if (singleton == null) {
//            synchronized (XmppConnectionB.class) {
//                if (singleton == null) {
//                    singleton = new XmppConnectionB();
//                }
//            }
//        }
//        return singleton;
...
//            Class.forName("org.jivesoftware.smackx.ServiceDiscoveryManager", true, XmppConnectionB.class.getClassLoader());
...
////     * @throws Exception
////     */
////    public MultiUserChat joinMultiUserChat2(String groupName, String nickname) throws Exception {
////        //群jid
