...
// * @author huang
// */
//public class ChatRecyclerListAdapterB extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
//
//    // 数据源
...
//
//    public ChatRecyclerListAdapterB(Context context, int doctor_id, ArrayList<YtecConsultMsgBean> list) {
//        super();
